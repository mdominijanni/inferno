...
class LastEventReducer(AbstractReducer):
    """Stores elementwise the number of observations since the observation of a tensor matched a target value.
...
class FuzzyLastEventReducer(AbstractReducer):
    """Stores elementwise the number of observations since the observation of a tensor matched a target value within an acceptable error.
