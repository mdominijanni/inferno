...
class QIF(VoltageMixin, SpikeRefractoryMixin, Neuron):
    ...
    def __init__(
        ...
        *,
        ...
        self.affinity, e = numeric_limit("affinity", affinity, 0, "gt", float)
        if e:
            raise e
...
class Izhikevich(AdaptationMixin, VoltageMixin, SpikeRefractoryMixin, Neuron):
    ...
    def __init__(
        ...
        *,
        ...
        # test values
        for idx, (tcA, vcA, siA) in enumerate(
        ...
        # reassign
        tc_adaptation, voltage_coupling, spike_increment = tcL, vcL, siL
